<?php 
    ...
    if(isset($userlogged) && !empty($userlogged)) {
        ...
        foreach($cart_products as $item) {
            $tong_san_pham++; 
            $tong_tien += (($item['so_luong'] * $item['don_gia_ban']) - ($item['so_luong'] * $item['don_gia_ban']) * 0.1);
        }
    }
?>
                                    ...
                                    ?>
                                        <li class="header-cart-menusub__item">
                                            <a href="" class="header-cart-menusub__link">
                                                <img src="./storage/uploads/img/<?=$arr_img[0]?>" alt="" class="header-cart-menusub__thumbnail">
                                                <div>
                                                    <p class="header-cart-menusub__name"><?=$item['ten_sp']?></p>
                                                    <div class="d-flex align-items-center justify-content-between">
                                                        <span class="header-cart-menusub__quantity">x<?=$item['so_luong']?></span>
                                                        <span class="header-cart-menusub__price"><?=currency_format($item['don_gia_ban'] - $item['don_gia_ban'] * 0.1)?></span>
                                                    </div>
                                                </div>
                                            </a>
                                        </li>
