...
if (!empty($adminlogged)) {
	$sql = "SELECT san_pham.id, ten_sp, don_gia_ban, ngay_nhap, loai_hang.ten_loai FROM san_pham, loai_hang WHERE loai_hang.id = san_pham.id_loai_hang";
                    ...
                    <tbody class="table-border-bottom-0">
                      <?php foreach($products as $item) { ?>
                        <tr>
                          ...
                          <td>
                            <?=currency_format($item['don_gia_ban'])?>
                          </td>
                          <td>
