...
if (!empty($adminlogged)) {
  ...
  if (!empty($id)) {
    ...
    if (isset($_POST['edit-product-submit']) && $_POST['edit-product-submit'] == 'submit') {
      ...
      if (empty($ngaynhap)) {
        $error['ngaynhap'] = 'Vui lòng chọn ngày nhập sản phẩm!';
      }

      if(empty($hinh_anh)) {
        $hinh_anh = $product['hinh_anh'];
      } else if(!empty($hinh_anh) && count(explode('||', $hinh_anh)) < 4) {

        $array_img = explode('||', $hinh_anh);
        $error['hinhanh'] = 'Vui lòng chọn tối thiểu 4 hình ảnh!';
      }
      

      if (empty($error)) {
        $stmt_insert_product = $conn->prepare("UPDATE `san_pham` SET `ten_sp`= ? ,`don_gia_nhap`= ? ,`don_gia_ban`= ? ,`so_luong_kho`= ? ,`mo_ta`= ? ,`hinh_anh`= ? ,`ngay_nhap`= ? ,`id_loai_hang`= ? ,`updated_at`= ? WHERE id = ?");
        $stmt_insert_product->bind_param("ssssssssss", $tensanpham, $dongianhap, $dongiaban, $soluong, $motasanpham, $hinh_anh, $ngaynhap, $id_loai, $date_current, $id);
                  ...
                  <div class="card mb-4 shadow-none">
                    <div class="card-body">
                      <div>
                        ...
                        <input type="text" class="form-control" id="tensanpham" name="tensanpham" value="<?php echo isset($product['ten_sp']) ? $product['ten_sp'] : ''; ?>" aria-describedby="defaultFormControlHelp" />
                  ...
                  <div class="card mb-4 shadow-none">
                    <div class="card-body">
                      <div>
                        ...
                        <input type="number" class="form-control" id="soluong" name="soluong" min="1" value="<?php echo isset($product['so_luong_kho']) ? $product['so_luong_kho'] : ''; ?>"  aria-describedby="defaultFormControlHelp" />
                        <span id="defaultFormControlHelp" class="form-text text-danger">
                  ...
                  <div class="card mb-4 shadow-none">
                    <div class="card-body">
                      <div>
                        ...
                        <input type="number" class="form-control" id="dongianhap" name="dongianhap" min="1" value="<?php echo isset($product['don_gia_nhap']) ? $product['don_gia_nhap'] : ''; ?>"  aria-describedby="defaultFormControlHelp" />
                        <span id="defaultFormControlHelp" class="form-text text-danger">
                  ...
                  <div class="card mb-4 shadow-none">
                    <div class="card-body">
                      <div>
                        ...
                        <input type="number" class="form-control" id="dongiaban" name="dongiaban" min="1" value="<?php echo isset($product['don_gia_ban']) ? $product['don_gia_ban'] : ''; ?>"  aria-describedby="defaultFormControlHelp" />
                        <span id="defaultFormControlHelp" class="form-text text-danger">
                  ...
                  <div class="card mb-4 shadow-none">
                    <div class="card-body">
                      <div>
                        ...
                        <input type="date" class="form-control" id="ngaynhap" name="ngaynhap" value="<?php echo isset($product['ngay_nhap']) ? $product['ngay_nhap'] : ''; ?>"  aria-describedby="defaultFormControlHelp" />
                        <span id="defaultFormControlHelp" class="form-text text-danger">
                ...
                <div class="col-md-12">
                  <div class="card mb-4 shadow-none">
                    <div class="card-body">
                      ...
                      <div class="grid-img d-flex flex-wrap align-items-start mt-4">
