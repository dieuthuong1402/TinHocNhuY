                                    ...
                                    <div class="card mb-4 shadow-none">
                                        <div class="card-body">
                                            <div>
                                                ...
                                                <input type="text" class="form-control" id="tendanhmuc" name="tendanhmuc" placeholder="John Doe" aria-describedby="defaultFormControlHelp" />
                                    ...
                                    <div class="card mb-4 shadow-none">
                                        <div class="card-body">
                                            <div>
                                                ...
                                                <input type="text" class="form-control" id="duongdan" name="duongdan" min="1" placeholder="John Doe" aria-describedby="defaultFormControlHelp" />
                                                <span id="defaultFormControlHelp" class="form-text text-danger">
                                                    <?php echo isset($error['message']) ? $error['message'] : ''; ?>
                                                </span>
                                            </div>
